    ...
    return (
        <div className="h-screen w-full flex flex-col font-sans neu-bg">
            <div className="flex-shrink-0 w-full">
                <header className="w-full max-w-2xl xl:max-w-5xl mx-auto h-16 flex items-center justify-between px-4 md:px-6">
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6 pb-24 xl:pb-28 animate-fade-in-up w-full">
                <div className="max-w-2xl xl:max-w-5xl mx-auto w-full">
                    {children}
                </div>
            </main>
             <div className="fixed bottom-0 left-0 right-0 h-16 bg-transparent z-50">
                <div className="w-full max-w-2xl xl:max-w-5xl mx-auto h-full px-4 xl:px-0">
