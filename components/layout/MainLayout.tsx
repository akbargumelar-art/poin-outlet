    ...
    return (
        <div className="h-screen w-full flex flex-col font-sans neu-bg">
            <div className="flex-shrink-0 w-full">
                <header className="max-w-2xl mx-auto h-16 flex items-center justify-between px-4 md:px-6">
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6 pb-48 animate-fade-in-up w-full">
