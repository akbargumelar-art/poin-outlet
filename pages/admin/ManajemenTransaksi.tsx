...
/* Added missing type imports for RunningProgram, LoyaltyProgram, SpecialNumber, and Redemption */
import { Transaction, User, RunningProgram, LoyaltyProgram, SpecialNumber, Redemption } from '../../types';
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ users, transactions, runningPrograms, loyaltyPrograms, specialNumbers, redemptions }) => {
    ...
    /* Fixed missing type import for RunningProgram */
